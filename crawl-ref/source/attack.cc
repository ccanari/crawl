...
int attack::calc_damage()
{
    if (stat_source().is_monster())
    {
        ...
        return apply_defender_ac(damage, damage_max, (using_weapon() && weapon_half_ac(*weapon)) ? ac_type::half : ac_type::normal);
    }
    else
    {
        ...
        damage = apply_defender_ac(damage, 0, (using_weapon() && weapon_half_ac(*weapon)) ? ac_type::half : ac_type::normal);
